    ...
    <div className="container py-4">
      ...
      <div className="flex gap-6">
        ...
        <main className="flex-1">
          {/* Top Bar */}
          <div className="card p-4 flex items-center justify-between mb-6 shadow-sm border-white/50">
            <span className="text-secondary text-sm">12,911 items in <span className="font-bold text-dark">Mobile accessory</span></span>
